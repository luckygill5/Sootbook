...
export const Registration = (formData) => {
    ...
    const {userid,file, companyname, industryselectedData, companyTypeData, countryselectedData, address, tin, vat, employeeNumber,heardValue, multibranch, subscribeNews } = formData;
    const RegistrationUrl = `${apiUrl}:${port}/api/admin/vendor/registration`
    return axios(RegistrationUrl, {
        method: "POST",
        headers: {
