        ...
        <React.Fragment>
            <div className='reviewCreate_container'>
                <div className='basicData_container'>
                    ...
                    <ul className='basic_listing'>
                        <li className='list_item'>
                            ...
                            <span className='text'>{basicFormData.role_name}</span>
                        </li>
                        <li className='list_item'>
                            <span className='label'>Description</span>
                            <span className='text'>{basicFormData.role_description}</span>
                        </li>
                    </ul>
                </div>
                ...
                <div className='bottom_actions'>
                    ...
                    <button className='nextBtn' type='button' onClick={() => handleReviewSave()}>
                        Save
                    </button>
                </div>
            </div>
            ...
            {roleAdded && (
                <Dialog
                    className='addRole_successModal'
                ...
                >
                    ...
                    <DialogTitle className='modal_title'>
                        The custom new role has been created successfully
                    </DialogTitle>
                    <p className='message'>
                        The new role has been successfully updated in the system.
                    </p>
                </Dialog>
            )}
