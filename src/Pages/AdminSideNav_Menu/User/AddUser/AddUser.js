                ...
                <div className='form_container'>
                    <form onSubmit={handleSubmit}>
                            ...
                            />
                            {
                                ...
                                <div className='suggestion_container'>
                                    ...
                                    {suggestionList.map((item, index) => {
                                        return (
                                            <li className='list_item' name={item._id} key={index} onClick={() => handleSelectSuggetion(item._id, `${item.first_name} ${item.last_name}`)}>{`${item.first_name} ${item.last_name}`}</li>
                                        )
                                    })}
                                    </ul>
                                </div>
                                ...
                                <FormGroup>
                                    {
                                        ...
                                        permission.map((item, index) => {
                                            return <FormControlLabel control={<Checkbox checked={permissionCheck.includes(item._id) ? true : false} name={item._id} onChange={handleManagePermission} />} label={item.name} />
                                        })
                                    }
                        ...
                        <div className='bottom_actions'>
                            ...
                            <button className='saveBtn' onClick={handleSubmit}>{locales.save_label}</button>
                        </div>
                    </form>
                </div>
            </div>
            {
                userAdded && <Dialog className='addUser_successModal' onClose={handleDialogClose} open={userAdded}>
                    ...
                    <DialogTitle className='modal_title'>User has been assigned successfully</DialogTitle>
