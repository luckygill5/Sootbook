            ...
            </div>
            {
                props.mode ? (
                    <div className='form_container'>
                        <div className='input_flexbox col-2'>
                            <div className='selectBox'>
                                <label className='mandate'>Allowance Option</label>
                                <Select
                    ...
                    <ul className='data_listing'>
                        <li className='list_item'><span className='label'>Allowance Option</span><span className='value'>Non Taxable</span></li>
