             ...
             <div className='table_section'>
                ...
                <div className='table_head'>
                    <div className='row col-4'>
                        ...
                        <div className='thead'>
                        <span className='text'>Reimbursements Option</span>
                            <div className='sort'>
                                <span className='up_icon'>
                                    <Arrow/>
                                </span>
            ...
            </div>
            {
                props.mode ? (
                    <div className='form_container'>
                        <div className='input_flexbox col-2'>
                            <div className='selectBox'>
                                <label className='mandate'>Reimbursements Option</label>
                                <Select
                        ...
                        <div className='input_flexbox col-2'>
                            ...
                            <div className='selectBox'>
                                <label className='mandate'>Amount</label>
                                <Select
                                    className="select_inputBox"
                                    labelId="demo-simple-select-label"
                                    id="demo-simple-select"
                    ...
                    <ul className='data_listing'>
                        <li className='list_item'><span className='label'>Reimbursements Option</span><span className='value'>Morning Shift</span></li>
                        <li className='list_item'><span className='label'>Amount Option</span><span className='value'>Fixed</span></li>
