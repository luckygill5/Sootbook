        ...
        <div className='changepassword_container'>
            ...
            </div>)}
            {
                        ...
                        <div className='alert_msg'>
                            <div className='flexbox'>
                                ...
                                <div className='para'>
                                    ...
                                    <p className='description'>Dont share this password to anyone. The password should be changed at least once in 3 months.</p>
                                </div>
                            </div>
                        </div>
                        <div className='input_flexBox col-2'>
                                <div className='inputBox'>
                                    ...
                                    <div className='flexbox'>
                                        ...
                                        <span className='toggleBtn' ref={passwordRef}  onClick={handlecurrenPassToggle}>
                            ...
                            <div className='input_flexBox col-2'>
                                <div className='inputBox'>
                                    ...
                                    <div className='flexbox'>
                                        <input type='password' className='input_password' ></input>
                                        <span className='toggleBtn' ref={newPass} onClick={handleNewPassToggle}>
                                            <img src={Toggle} alt="toggle" className='eye_icon'></img>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div className='flexbox'>
                                        <input type='password' className='input_password' ></input>
                                        <span className='toggleBtn' ref={RepeatNewPass} onClick={handleRepeatnewpassToggle}>
                                        <img src={Toggle} alt="toggle" className='eye_icon'></img>
                                        </span>
                                    </div>
                                </div>
                ...
                : (
                    ...
                    <li className='list_item'><span className='label'>Password</span><span className='value'>• • • • • • • • • •</span></li>
                </ul>
                )
            }
